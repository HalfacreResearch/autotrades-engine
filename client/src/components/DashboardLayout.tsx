            ...
            <div className="flex items-center gap-3 px-2 w-full">
              ...
              {!isCollapsed && (
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="font-semibold tracking-tight truncate">Auto Trades</span>
                </div>
              )}
            </div>
          </SidebarHeader>
            ...
            <div className="flex items-center gap-2 px-2 py-1">
              ...
              {!isCollapsed && (
                <div className="min-w-0">
                  <p className="text-xs font-medium truncate">CodexYield Staff</p>
                  <p className="text-xs text-muted-foreground truncate">Operator View</p>
                </div>
              )}
            </div>
          </SidebarFooter>
